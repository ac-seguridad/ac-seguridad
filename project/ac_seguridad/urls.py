...
urlpatterns = [
    ...
    url(r'^registro-personas/$', views.registro_persona, name='registro_persona'),
    url(r'^registro-estacionamiento/$', views.registro_estacionamiento, name='registro_estacionamiento'),
    url(r'^login/$', auth_views.LoginView.as_view(template_name='ac_seguridad/registration/login.html'), name='login'),
